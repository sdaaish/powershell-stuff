...
.DESCRIPTION
Requires that emacs64 is installed and the command-file emx.cmd, from https://raw.githubusercontent.com/sdaaish/winstuff/master/emx.cmd.
...
function find-command {
    try  {
        ...
        Write-Host -ForeGroundColor Red "Could not find emx.cmd"
        break
    }
